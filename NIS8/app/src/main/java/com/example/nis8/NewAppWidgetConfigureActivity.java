...
import com.example.nis8.databinding.NewAppWidgetConfigureBinding;
        ...
        if (extras != null) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    @SuppressLint("UnspecifiedImmutableFlag") PendingIntent pending = PendingIntent.getActivity(context, 0,
                            intent, 0);
